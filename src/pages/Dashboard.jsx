  ...
  const handleCreateRoom = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          title: "Room Created",
          description: `Room ${roomId.trim()} created successfully`,
        });
        ...
        toast({
          ...
          description: errorData.error || "Room creation failed",
          variant: "destructive",
        });
      }
    } catch (error) {
  ...
  const handleJoinRoom = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          title: "Joined Room",
          description: `Successfully joined room ${joinRoomId.trim()}`,
        });
